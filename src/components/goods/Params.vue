...
export default {
  ...
  methods:{
    ...
    showInput(row){
      ...
      //让文本框自动获得焦点
      //nextTick方法的作用当页面上元素被重新渲染之后才会执行回调函数的代码
      this.$nextTick(_=>{
    ...
    async removeParams(attr_id){
       const confirmResult = await this.$confirm('此操作将永久删除该参数，是否继续?','提示',{confirmButtonText: '确定',
       cancelButtonText: '取消',type:'warning'}).catch(err=>err)
       //用户取消了删除的操作
